...
import com.example.ch4.Data.LoginInfor;
import com.example.ch4.Data.Table;
import com.example.ch4.models.CheckLogin;
import com.example.ch4.models.TableAlters;
...
public class WebController {
    ...
    @RequestMapping("/add")
    public String showAdd(ContactInfor cont, Model model) {
    ...
    @PostMapping("/alter")
    public String showAlter(HttpServletRequest request, @ModelAttribute(value = "row") Integer row, ContactInfor m, Model model) {
